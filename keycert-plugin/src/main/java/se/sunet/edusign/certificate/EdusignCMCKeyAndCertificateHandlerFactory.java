...
/**
 * Factory for creating the eduSign custom {@link KeyAndCertificateHandler}.
 *
 * @author Martin Lindström
 */
@Slf4j
public class EdusignCMCKeyAndCertificateHandlerFactory extends AbstractKeyAndCertificateHandlerFactory {
  ...
  protected AbstractKeyAndCertificateHandler createKeyAndCertificateHandler(
    ...
    try {
      ...
      return new EduSignCMCKeyAndCertificateHandler(keyProvider, algorithmKeyTypeMap, attributeMapper, algorithmRegistry,
